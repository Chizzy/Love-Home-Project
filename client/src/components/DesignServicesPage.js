    ...
    render() {
        return (
            <PricingTable highlightColor='#398274'>
                <PricingSlot highlighted onClick={this.submit} buttonText='PURCHASE' title='Love Home Basic'
                             priceText='$59/room'>
                ...
                <PricingSlot highlighted onClick={this.submit} buttonText='PURCHASE' title='Love Home Plus' priceText='$79/room'>
                    <PricingDetail> <b>✓</b> Love Home builds your room in 3D</PricingDetail>
                ...
                <PricingSlot highlighted onClick={this.submit} buttonText='PURCHASE' title='Love Home Premium'
                             priceText='$169/room'>
                    <PricingDetail> <b>✓</b> Love Home builds your room in 3D</PricingDetail>
                    <PricingDetail> <b>✓</b> Concierge shopping service</PricingDetail>
                    <PricingDetail> <b>✓</b> Designs delivered in 7-10 days</PricingDetail>
